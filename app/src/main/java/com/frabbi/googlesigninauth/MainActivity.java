...
import com.frabbi.googlesigninauth.databinding.ActivityMainBinding;
...
public class MainActivity extends BaseActivity<ActivityMainBinding> {
    ...
    protected void setViewCreated(Bundle saveInstanceState) {
        ...
        vB.signInButton.setOnClickListener(view -> {
            signIn();
        });
    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Snackbar.make(vB.getRoot(), "Authentication Failed.", Snackbar.LENGTH_SHORT).show();
                            updateUI(null);
                        }
